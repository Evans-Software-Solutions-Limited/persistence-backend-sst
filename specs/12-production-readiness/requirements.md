...
| 5   | Sentry                     | `@sentry/react-native` for mobile, `@sentry/node` for SST Lambda. Source maps uploaded on every EAS build. PII scrubbed at ingest (no user emails or trainer client names in breadcrumbs).                                                                                                                 |
