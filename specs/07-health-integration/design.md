...
| Android                   | `HealthConnectAdapter` | Read steps, active/basal calories, weight, body fat, heart rate and sleep; write weight, body fat and sleep; permission request/status; provider availability                                                                                                                      | Uses `react-native-health-connect`. Android 13 and lower use the Play-installed provider; Android 14+ uses the system provider. Missing/outdated-provider state links to the Health Connect Play listing. Apple Stand Time has no Health Connect equivalent and returns zero.                                                        |
