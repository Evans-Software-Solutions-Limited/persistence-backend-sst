      ...
      <ScrollView style={styles.content} testID="privacy-policy-scroll">
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bodyText}>
            ...
            use Supabase for data storage and authentication, which complies
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bodyText}>
            ...
            collect, monitor, and analyze information. These third parties have
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bodyText}>
            ...
            us at admin@evans-software-solutions.com
          </Text>
        </View>
      </ScrollView>
    </View>
